...
Notre méthode de génération d'un temps aléatoire unifié à partir du moyen est indiquée par l'équation suivante. L'opérateur \textit{ln} est utilisé pour que la variable générée soit plus unifiée. La variable T est la même que dans la configuration,pour assurer que la voiture suivante arrive au moins après un temps de sécurité.
\begin{subequations}
\begin{align}
