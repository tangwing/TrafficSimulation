...
glut.h à \verb§c:\program files\mingw\include\GL§. Ce sont tous les positions par défault, en principe, les fichers *.dll doit toujours être placé sous le répertoire système Windows; les *.lib et *.h sont mis respectivement sous les répertoire de librairie et de ficher d'en-tête du compilateur.
